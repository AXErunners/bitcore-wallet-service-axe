...
FiatRateService.prototype._retrieve = function(provider, cb) {
  ...
  async.waterfall([
      function(callback){
          log.debug('Fetching data for CoinMarketCap');
          self.request.get({
              url: 'https://api.coinmarketcap.com/v1/ticker/axe/?convert=USD',
              json: true
              ...
              log.debug('Data for CoinMarketCap fetched successfully');
      ...
      function(data, callback){
          ...
          self.request.get({
              ...
              var rates = provider.parseFn(body, data);
